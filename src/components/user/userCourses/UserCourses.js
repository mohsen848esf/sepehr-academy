...
class UserCourses extends Component {
    ...
    render() {
        const {courseId , courseImage , courseName , courseLevel , startDate , courseStatus} = this.state;
        return (
            <Fragment>
                                  
            <div className="  tab-pane fade myCourses-panel show active" id="v-pills-myCourses" role="tabpanel" aria-labelledby="v-pills-myCourses-tab">
                          ...
                          <table className="table table-sm text-responsive">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>{courseStatus}</td>
                                <td>
                                  <button type="button" className="btn btn-primary"><i className="fa fa-trash"></i></button>
                                </td>
                              </tr>
