...
class UserCourseList extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                {selectedTab["_id"] === "my-courses" && count === 0 ? <p>هیچ دوره ای ثبت نشده است.</p> : 
        <div className={selectedTab["_id"] === "my-courses" ? "tab-pane fade myCourses-panel show active" : "tab-pane fade myCourses-panel"} id="v-pills-myCourses" role="tabpanel" aria-labelledby="v-pills-myCourses-tab">
